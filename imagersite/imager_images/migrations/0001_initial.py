# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-07-24 07:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.CharField(choices=[(b'PB', b'public'), (b'PV', b'private'), (b'SH', b'shared')], default=b'PV', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', sorl.thumbnail.fields.ImageField(upload_to=b'images')),
                ('published', models.CharField(choices=[(b'PB', b'public'), (b'PV', b'private'), (b'SH', b'shared')], default=b'PV', max_length=2)),
                ('date_uploaded', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('date_published', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='imageralbum',
            name='photos',
            field=models.ManyToManyField(blank=True, default=b'', related_name='albums', to='imager_images.ImagerPhoto'),
        ),
        migrations.AddField(
            model_name='imageralbum',
            name='tags',
